...
# mutating df
job_search_corr_clean %>% 
  # ordering data by correlation strength to job_search
  mutate(term = factor(term, levels = term[order(job_search)])) %>%
  # creating plot
  # base layer: ggplot
  ggplot(
